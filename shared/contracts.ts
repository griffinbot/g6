...
export interface GoNoGoThresholds {
  windSpeedGo: number;
  windSpeedMarginal: number;
  gustGo: number;
  gustMarginal: number;
  visibilityGo: number;
  visibilityMarginal: number;
  dewPointSpreadGo: number;
  dewPointSpreadMarginal: number;
}
...
export interface UserPreferences {
  ...
  goNoGoThresholds: GoNoGoThresholds;
}
...
export const DEFAULT_GO_NO_GO_THRESHOLDS: GoNoGoThresholds = {
  ...
  gustMarginal: 12,
  visibilityGo: 5,
  visibilityMarginal: 3,
  dewPointSpreadGo: 5,
  dewPointSpreadMarginal: 3,
};
